...
KL.Text = "SCRIPT DC TẠO BỞI TANCUCXUC😡😡😡 DZ SỐ 1 TG "
...
local Tabs = {
    ...
    an = Window:AddTab({ Title = "Misc ", Icon = "" }),
...
ImageButton.BackgroundColor3 = Color3.fromRGB(255,102,102)
ImageButton.BorderSizePixel = 0
ImageButton.Position = UDim2.new(0.120833337, 0, 0.0952890813, 0)
ImageButton.Size = UDim2.new(0, 50, 0, 55)
ImageButton.Draggable = true
ImageButton.Image = "rbxassetid://71643263677630"
...
local Toggle = Tabs.item:AddToggle("Auto Saber", { Title = "Farm Saber", Default = false })
Toggle:OnChanged(function(Value)
    _G.Cuttay = Value
    StopTween(_G.Cuttay)
end)
...
local Toggle = Tabs.item:AddToggle("Auto Pole", { Title = "Farm Pole", Default = false })
...
local Toggle = Tabs.item:AddToggle("Auto Rengoku", { Title = "Farm Rengoku", Default = false })
Toggle:OnChanged(function(Value)
    _G.Kiem_Lua = Value
...
local Toggle = Tabs.item:AddToggle("Auto Ectoplasm", { Title = "Farm Ectoplasm", Default = false })
Toggle:OnChanged(function(Value)
    Auto_Ki_Di = Value
