...
local Window = OrionLib:MakeWindow({Name = "Nameless hub", HidePremium = false, SaveConfig = true, ConfigFolder = "Nameless hub"})
...
Notify("Welcome To Nameless hub Release",5)
...
I:AddLabel("Owner : tanyeuem")

I:AddLabel("hoacodon and xuan yeu men")
I:AddLabel("Version : Main")

I:AddLabel("9a3 on top")
